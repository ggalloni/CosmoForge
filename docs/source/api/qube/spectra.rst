...
.. code-block:: python
   ...
   if spectra.rank == 0:
       cls_TT = spectra.get_power_spectra('TT')
       cls_EE = spectra.get_power_spectra('EE')
       cls_BB = spectra.get_power_spectra('BB')

       print(f"Estimated TT spectrum range: {cls_TT.min():.2e} - {cls_TT.max():.2e}")
...
.. code-block:: python
   ...
   if spectra.rank == 0:
       ...
       bandpowers = spectra.get_power_spectra('TT')
       covariance = spectra.get_covariance_matrix()
