...
# Attributes as field lists. With directives instead, autodoc documents an
# annotated dataclass field a second time and the build warns.
...
html_logo = "_static/logo_cosmoforge.png"
