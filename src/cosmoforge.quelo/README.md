...
Quelo is part of CosmoForge and installs automatically:
...
Quelo uses YAML configuration files:
...
```python
from quelo.scripts.generate_mock_data import generate_cmb_maps
