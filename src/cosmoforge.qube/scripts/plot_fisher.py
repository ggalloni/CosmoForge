...
def fisher_plotting(show_fig=False, save_fig=False):
    ...
    file = "src/cosmoforge.qube/outputs/TEB_fisher.dat"
    # file = "src/cosmoforge.qube/inputs/EB_ns008_1ch_r0.0_fsky100_AxA_QU_fisher.dat"
    ...
    # file = "src/cosmoforge.qube/tests/data/QU_ref_fisher.dat"
    file = "src/cosmoforge.qube/tests/data/TEB_ref_fisher.dat"
    # file = "src/cosmoforge.qube/tests/data/EB_ref_fisher.dat"
    ...
    for i, j in couples:
        ...
        plt.colorbar()
        plt.title(f"Fisher Matrix QUBE - Block ({i})")
        if save_fig:
            plt.savefig(
                f"src/cosmoforge.qube/plots/QUBE_fisher_block_{i}.png",
                bbox_inches="tight",
            )
        ...
        if save_fig:
            plt.savefig(
                f"src/cosmoforge.qube/plots/pse_qml_fisher_block_{j}.png",
                bbox_inches="tight",
            )
        ...
        if save_fig:
            plt.savefig(
                f"src/cosmoforge.qube/plots/QUBE_pse_qml_fisher_diff_block_{i}_{j}.png",
                bbox_inches="tight",
            )
        if show_fig:
            plt.show()
    ...
    plt.colorbar()
    plt.title("Fisher Matrix QUBE - Off-diagonal Block (T-QU)")
    if save_fig:
        plt.savefig(
            "src/cosmoforge.qube/plots/QUBE_fisher_offdiag_block_T-QU.png",
            bbox_inches="tight",
        )
    ...
    if save_fig:
        plt.savefig(
            "src/cosmoforge.qube/plots/pse_qml_fisher_offdiag_block_T-QU.png",
            bbox_inches="tight",
        )
    ...
    if save_fig:
        plt.savefig(
            "src/cosmoforge.qube/plots/QUBE_pse_qml_fisher_offdiag_diff_block_T-QU.png",
            bbox_inches="tight",
        )
    if show_fig:
        plt.show()
    ...
    plt.colorbar()
    plt.title("Fisher Matrix QUBE - Off-diagonal Block full")
    if save_fig:
        plt.savefig("src/cosmoforge.qube/plots/QUBE_fisher_full.png", bbox_inches="tight")
    ...
    if save_fig:
        plt.savefig(
            "src/cosmoforge.qube/plots/pse_qml_fisher_full.png", bbox_inches="tight"
        )
    ...
    if save_fig:
        plt.savefig(
            "src/cosmoforge.qube/plots/QUBE_pse_qml_fisher_offdifull.png",
            bbox_inches="tight",
        )
    if show_fig:
        plt.show()
