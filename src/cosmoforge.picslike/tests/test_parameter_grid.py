...
class TestParameterGrid:
    ...
    def test_grid_initialization(
        self, sample_parameter_ranges, sample_theoretical_spectra
    ):
        """Test basic grid initialization."""
        grid = ParameterGrid(sample_parameter_ranges, sample_theoretical_spectra)
    ...
    def test_mpi_distribution(self, sample_parameter_ranges, sample_theoretical_spectra):
    ...
    def test_grid_shape(self, sample_parameter_ranges, sample_theoretical_spectra):
    ...
    def test_parameter_index(self, sample_parameter_ranges, sample_theoretical_spectra):
    ...
    def test_spectrum_addition(self, sample_parameter_ranges):
        ...
        with pytest.raises(ValueError):
            ParameterGrid(sample_parameter_ranges, empty_spectra)
    ...
    def test_empty_parameter_ranges(self):
        ...
        grid = ParameterGrid(empty_ranges, empty_spectra)
        assert grid.get_total_points() == 0
        assert len(grid.grid_points) == 0

    def test_contains_method(self, sample_parameter_ranges, sample_theoretical_spectra):
    ...
    def test_len_method(self, sample_parameter_ranges, sample_theoretical_spectra):
        """Test __len__ method."""
        grid = ParameterGrid(sample_parameter_ranges, sample_theoretical_spectra)

        assert len(grid) == 9

    def test_iter_method(self, sample_parameter_ranges, sample_theoretical_spectra):
